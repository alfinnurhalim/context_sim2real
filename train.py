...
train_loader_mixed = DataLoader(train_dataset_mixed, batch_size=1, shuffle=True, num_workers=4)
...
for ratio in keep_ratio:
    ...
    for batch_id,(source_image,style_image) in tqdm(enumerate(train_loader_mixed)):
        trainer.train(batch_id, source_image, style_image)
